        ...
        if (!signatureMatch) {
            ...
            _console.groupCollapsed(locale.moreInfo);
                if (this instanceof _jQuery) {
                    _/*console.log(locale.collection, sliced)*/;
                }
                logLocation();
                _/*console.log(locale.youPassed, args)*/;
                ...
                if (ret[0]) {
                    ...
                    if ( lint.enabledReports.repeatSelector && selectorCache[selector] && compare(selectorCache[selector], ret) ) {
                        ...
                        _console.groupCollapsed(locale.info);
                            logLocation();
                            _/*console.log(locale.selector + '"' + selector + '"')*/;
                            _/*console.log(locale.selectorAdvice)*/;
                        _console.groupEnd();
